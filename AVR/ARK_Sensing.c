...
//#include "bmi160_handler.h"			// BMI160 Methods
//#include "bmi160_handler.c"			// BMI160 Methods
...
int main(void) {
	...
	int register_address = BMI160_GYRO_DATA_ADDR;// BMI160_GYRO_DATA_ADDR = 0x0C is 1st byte of Gyro X
